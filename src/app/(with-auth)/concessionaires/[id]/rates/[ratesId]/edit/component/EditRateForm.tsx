...
import { NewRateSchema, NewRateSchemaType, IntervalRateSchemaType } from "@/schemas/new-rates.schema";
                    ...
                    <FormItem>
                      <FormControl>
                        <Input
                          ...
                          className="w-full"
                          type="number"
                          onChange={(e) => field.onChange(formatMoney(Number(e.target.value)))}
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
